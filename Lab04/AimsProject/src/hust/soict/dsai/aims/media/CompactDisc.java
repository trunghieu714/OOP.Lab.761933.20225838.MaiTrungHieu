...
public class CompactDisc extends Disc implements Playable {
    ...
    public void play() {
        ...
        if (totalLength <= 0) {
            System.out.println("Error: The CD \"" + this.getTitle() + "\" cannot be played because its total length is 0 or less.");
        } else {
            System.out.println("Playing CD: " + this.getTitle() + " by artist " + this.artist);
            System.out.println("CD director: " + this.getDirector());
            System.out.println("CD total length: " + totalLength + " mins");
