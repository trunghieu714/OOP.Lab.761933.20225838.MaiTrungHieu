...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Your choice (1-2, default is 2): ");
        String choice = scanner.nextLine().trim();
        if (choice.equals("1")) {
            mainMenuLoop();
        } else {
            System.out.println("Launching GUI mode...");
            new hust.soict.dsai.aims.screen.StoreScreen(store, cart);
        }
    }
                ...
                case 2:
                    if (media instanceof Playable) {
                        try {
                            ...
                            System.out.println("PlayerException occurred: " + e.getMessage());
